...
main()
{
	...
	level._effect[ "drips_slow" ]					= undefined;//loadfx( "misc/drips_slow" );
	level._effect[ "drips_slow_infrequent" ]		= undefined;//loadfx( "misc/drips_slow_infrequent" );
	...
	level._effect[ "deathfx_bloodpool" ]			= undefined;//loadfx( "impacts/deathfx_bloodpool" );
	level._effect[ "blood_drip" ]					= undefined;//loadfx( "impacts/blood_drip" );
