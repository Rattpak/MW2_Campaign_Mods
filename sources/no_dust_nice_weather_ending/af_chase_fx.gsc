...
/*-----------------------------------------------------------------------------------------------------*/
	...
	level._effect[ "crawl_dust_sandstorm_runner" ]				 	 = undefined;//LoadFX( "impacts/crawl_dust_sandstorm_runner" );
	level._effect[ "footstep_dust_sandstorm_runner" ]				 = undefined;//LoadFX( "impacts/footstep_dust_sandstorm_runner" );
	level._effect[ "footstep_dust_sandstorm_small_runner" ]			 = undefined;//LoadFX( "impacts/footstep_dust_sandstorm_small_runner" );
	level._effect[ "bodyfall_dust_sandstorm_large_runner" ]			 = undefined;//LoadFX( "impacts/bodyfall_dust_sandstorm_large_runner" );

	
	// need something cool here.
	level._effect[ "body_falls_from_ropes_splash"			 ] = LoadFX( "impacts/large_waterhit" );

	level._effect[ "sand_storm_distant" ]				 	 = undefined;//LoadFX( "weather/sand_storm_distant" );
	level._effect[ "sand_storm_canyon_light" ]				 = undefined;//LoadFX( "weather/sand_storm_canyon_light" );
	level._effect[ "sand_storm_player" ]					 = undefined;//LoadFX( "weather/sand_storm_player" );
	level._effect[ "sand_storm_intro" ]						 = undefined;//LoadFX( "weather/sand_storm_intro" );
	level._effect[ "sand_storm_light" ]						 = undefined;//LoadFX( "weather/sand_storm_light" );
	level._effect[ "sand_storm_distant_oriented" ] 			 = undefined;//LoadFX( "weather/sand_storm_distant_oriented" );
	level._effect[ "sand_spray_detail_runner0x400" ]	 	 = undefined;//LoadFX( "dust/sand_spray_detail_runner_0x400" );
	level._effect[ "sand_spray_detail_runner400x400" ]	 	 = undefined;//LoadFX( "dust/sand_spray_detail_afchase_runner_400x400" );
	level._effect[ "sand_spray_detail_oriented_runner" ]	 = undefined;//LoadFX( "dust/sand_spray_detail_oriented_runner" );
	level._effect[ "sand_spray_detail_oriented_runner" ]	 = undefined;//LoadFX( "dust/sand_spray_detail_oriented_runner" );
	level._effect[ "sand_spray_cliff_oriented_runner" ] 	 = undefined;//LoadFX( "dust/sand_spray_cliff_oriented_runner" );

	level._effect[ "dust_wind_fast" ]						 = undefined;//LoadFX( "dust/dust_wind_fast_afcaves" );
	level._effect[ "dust_wind_canyon" ]						 = undefined;//LoadFX( "dust/dust_wind_canyon_far" );
	...
	level._effect[ "light_shaft_ground_dust_small" ]	 	 = undefined;//LoadFX( "dust/light_shaft_ground_dust_small" );
	level._effect[ "light_shaft_ground_dust_large" ]	 	 = undefined;//LoadFX( "dust/light_shaft_ground_dust_large" );
	level._effect[ "light_shaft_ground_dust_small_yel" ]	 = undefined;//LoadFX( "dust/light_shaft_ground_dust_small_yel" );
	level._effect[ "light_shaft_ground_dust_large_yel" ]	 = undefined;//LoadFX( "dust/light_shaft_ground_dust_large_yel" );
	level._effect[ "light_shaft_motes_afchase" ]			 = undefined;//LoadFX( "dust/light_shaft_motes_afchase" );
	
	if ( level.script == "ending" )
		level._effect[ "light_glow_white_bulb" ]			 	 = undefined;//LoadFX( "dust/light_shaft_motes_afchase" );
	else
	...
	level._effect[ "heli_blinds_player" ]					 = undefined;//LoadFX( "weather/sand_storm_player_blind" );
